...
apt install build-essential libqt4-dev qt5-qmake cmake qttools5-dev
libqt5webkit5-dev qttools5-dev-tools qt5-default python-sphinx
...
automake nano qtbase5-dev qt4-dev-tools libqt4-core libqt4-gui libqt5-core
libqt5-gui
